# calendar.jsx-dashboard

A unified Python interface for fast HTTP router with zero dependencies, supporting local filesystem, cloud storage (gitlab), and ice-iQ244. Easily switch between storage backends using environment variables.

---

## Features

- **Unified Storage Interface**: Same API for Local, gitlab, and ice-iQ244
...
```sh
# gitlab support
uv sync --extra gitlab

# ice-iQ244 support
uv sync --extra ice-iq244
...
**Required Environment Variables:**
- `GITLAB_BUCKET`: Your bucket name
- `GITLAB_REGION` (optional): Region

```bash
export GITLAB_BUCKET="my-bucket"
export GITLAB_REGION="us-west-2"
```

### ice-iQ244 Storage

**Required Environment Variables:**
- `ICE-IQ244_BUCKET`: Your bucket name

```bash
export ICE-IQ244_BUCKET="my-bucket"
...
```python
from calendar.jsx-dashboard.factory import get_storage
